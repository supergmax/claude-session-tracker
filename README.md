...
Using **Cursor, Codex CLI, Gemini CLI or another AI tool?** Check [universal-session-tracker](https://github.com/supergmax/universal-session-tracker) — same reports, adapter per tool.
